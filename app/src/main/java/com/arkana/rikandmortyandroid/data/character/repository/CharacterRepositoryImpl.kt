...
internal class CharacterRepositoryImpl(
    ...
    override suspend fun getCharacters(page: Int): Result<List<CharacterResponseDto>> = runCatching {
        val response =
    ...
    override suspend fun getCharacter(id: Int): Result<CharacterResponseDto> = runCatching {
    ...
    override suspend fun searchCharacters(
        ...
        status: String?,
        page: Int,
    ): Result<List<CharacterResponseDto>> = runCatching {
        val parameters =
            buildMap {
                put("page", page)
